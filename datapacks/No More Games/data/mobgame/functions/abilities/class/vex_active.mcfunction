...
execute if score @s mobgame.cooldown1 matches 600.. if score @s mobgame.cooldown2 matches 100.. if entity @s[team=Gold] run effect give @a[team=!Gold,distance=..12] darkness 15 0 true
execute if score @s mobgame.cooldown1 matches 600.. if score @s mobgame.cooldown2 matches 100.. if entity @s[team=Lime] run effect give @a[team=!Lime,distance=..12] darkness 15 0 true
execute if score @s mobgame.cooldown1 matches 600.. if score @s mobgame.cooldown2 matches 100.. if entity @s[team=Maroon] run effect give @a[team=!Maroon,distance=..12] darkness 15 0 true
execute if score @s mobgame.cooldown1 matches 600.. if score @s mobgame.cooldown2 matches 100.. if entity @s[team=Purple] run effect give @a[team=!Purple,distance=..12] darkness 15 0 true
